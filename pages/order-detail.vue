            ...
            <div class="divide-y divide-gray-200 dark:divide-gray-700">
              <div v-for="(item,index) in orders" :key="index" class="flex flex-wrap items-center gap-y-4 py-6">
                ...
                <dl class="w-1/2 sm:w-1/4 lg:w-auto lg:flex-1">
                  ...
                  <dd class="mt-1.5 text-base font-semibold text-gray-900 dark:text-white">{{ formatDate(item.created_at)}}</dd>
                </dl>
                <dl class="w-1/2 sm:w-1/4 lg:w-auto lg:flex-1">
                  <dt class="text-base font-medium text-gray-500 dark:text-gray-400">Total items:</dt>
                  <dd class="mt-1.5 text-base font-semibold text-gray-900 dark:text-white">{{item.order_items.length}} items</dd>
                </dl>
                <dl class="w-1/2 sm:w-1/4 lg:w-auto lg:flex-1">
                ...
                <div class="w-full grid sm:grid-cols-2 lg:flex lg:w-64 lg:items-center lg:justify-end gap-4">
                  ...
                  <a :href="`/view-order-detail/${item.id}`"
