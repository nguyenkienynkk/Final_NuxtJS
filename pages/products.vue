      ...
      <nav class="bg-white border-gray-200 px-4 lg:px-6 py-2.5 dark:bg-gray-800">
        <div class="flex flex-wrap justify-between items-center mx-auto max-w-screen-xl">
          <a href="https://flowbite.com" class="flex items-center">
            ...
            <span class="self-center text-xl font-semibold whitespace-nowrap dark:text-white">Vistore</span>
          </a>
      ...
      <div class="container mx-auto px-6 lg:px-8">
        <div v-if="!isLoggedIn" class="text-center">
          ...
          <button @click="router.push('/login')"
                  class="mt-4 py-2 px-4 bg-fuchsia-700 text-white font-medium rounded-lg shadow-md hover:shadow-lg transition-transform duration-200 hover:scale-105 ease-in-out">
            Login
          </button>
        </div>
        <div v-else>
          <div class="text-center mb-12">
            <h2 class="text-4xl text-gray-900 dark:text-white">Our Products</h2>
          </div>
          <div
              class="search-form-container mb-8 p-6 bg-white rounded-2xl shadow-lg dark:bg-gray-800 transition-all duration-700 transform opacity-0 translate-x-full"
            ...
            <form @submit.prevent="searchProducts">
              ...
              <div class="flex justify-center mt-8">
                <button type="submit"
                     ...
                     transition-transform duration-300 hover:scale-105 ease-in-out focus:ring-4 focus:ring-fuchsia-500">
                  Search
                </button>
              </div>
            </form>
          ...
          <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
            <div v-for="(item, index) in products" :key="index"
                 class="bg-white rounded-2xl shadow-lg dark:bg-gray-800 p-6 flex flex-col justify-between transition-transform duration-300 hover:scale-105 hover:shadow-2xl hover:bg-gradient-to-br
               hover:from-purple-100 hover:to-indigo-100 dark:hover:from-gray-700 dark:hover:to-gray-800">

              <div class="relative overflow-hidden rounded-lg mb-5">
                <img :src="item.preview_img_path" alt="Product Image"
              ...
              <h3 class="text-2xl font-semibold text-gray-900 dark:text-white bg-clip-text text-transparent bg-gradient-to-r from-purple-500 to-indigo-500 mb-3">
                {{ item.name }}
              </h3>
...
if (token) {
  ...
  user.value.avatar = userAvatar || 'http://res.cloudinary.com/dccuxj8ll/image/upload/v1731313943/PRODUCTS/cqvznbmtpzecvvq0tadu.png';
} else {
